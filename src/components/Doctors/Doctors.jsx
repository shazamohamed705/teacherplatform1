...
const doctors = [
  {
    ...
    items: [
      ...
      { id: 4,  type: 'video', src: '/4B.MOV',             title: 'Reel 02',     size: 'small' },
      { id: 5,  type: 'image', src: '/2.3.png',            title: 'Campaign 03', size: 'large' },
      { id: 6,  type: 'video', src: '/5A.MOV',             title: 'Reel 03',     size: 'small' },
      { id: 7,  type: 'image', src: '/2.4.png',            title: 'Campaign 04', size: 'large' },
      { id: 8,  type: 'video', src: '/6.MOV',              title: 'Reel 04',     size: 'small' },
      { id: 9,  type: 'image', src: '/2.5 OPTION 2.png',   title: 'Campaign 05', size: 'small' },
      { id: 10, type: 'video', src: '/8 - Take 1.MOV',     title: 'Reel 05',     size: 'small' },
      { id: 11, type: 'image', src: '/2.6.png',            title: 'Campaign 06', size: 'large' },
      { id: 12, type: 'video', src: '/8 - Take 2.MOV',     title: 'Reel 06',     size: 'small' },
      { id: 13, type: 'video', src: '/10A.MOV',            title: 'Reel 07',     size: 'small' },
      { id: 14, type: 'video', src: '/10B.MOV',            title: 'Reel 08',     size: 'small' },
      { id: 15, type: 'video', src: '/11B.MOV',            title: 'Reel 09',     size: 'small' },
      { id: 16, type: 'video', src: '/IMG_7945.mov',       title: 'Reel 10',     size: 'small' },
    ],
  },
  {
    id: 'afaf',
